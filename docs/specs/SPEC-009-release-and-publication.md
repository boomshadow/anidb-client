...
The package states its maturity to the index in its own metadata, as a judgement about the project rather than something derived from the version number.
